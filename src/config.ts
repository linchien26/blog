...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    subtitle: '起于野',
    // site description
    description: 'Learning, Intelligence, Investment & Notes.',
    // use i18n title/subtitle/description from src/i18n/ui.ts instead of static ones above
    i18nTitle: false, // true | false
    // author name
    author: '林间',
    // site url
    url: 'https://linchien26.github.io', // e.g., https://example.com
    // base path
  ...
  color: {
    ...
    light: {
      ...
      highlight: 'oklch(0.5118 0.0847 133.14 / 0.5)', // rgb(83, 113, 61, 0.5)
    },
    dark: {
      // primary color
      ...
      // highlight color
      highlight: 'oklch(0.5118 0.0847 133.14 / 0.2)', // rgb(83, 113, 61, 0.2)
    },
  },
  // COLOR SETTINGS >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> END
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'Email',
        url: 'mailto:linchien@foxmail.com',
      },
      // {
      //   name: 'X',
